...
TEST_F(TestMatrix, test_constructor) {
	...
	matrix::Matrix matrix5(17, 200);
	ASSERT_EQ(matrix5.getRows(), 17);
	ASSERT_EQ(matrix5.getColumns(), 200);
	
	ASSERT_NO_THROW(matrix::Matrix(2, 1000000000000));
	matrix::Matrix matrix6(2, 1000000000000);
	ASSERT_EQ(matrix6.getRows(), 0);
	ASSERT_EQ(matrix6.getColumns(), 0);
	
	ASSERT_NO_THROW(matrix::Matrix(10000000000000, 2));
	matrix::Matrix matrix7(2, 1000000000000);
	ASSERT_EQ(matrix7.getRows(), 0);
	ASSERT_EQ(matrix7.getColumns(), 0);
	
	ASSERT_NO_THROW(matrix::Matrix(10000000000000, 100000000000));
	matrix::Matrix matrix8(10000000000000, 100000000000);
	ASSERT_EQ(matrix8.getRows(), 0);
	ASSERT_EQ(matrix8.getColumns(), 0);
	
	ASSERT_NO_THROW(matrix::Matrix(0, 1000000000000));
	matrix::Matrix matrix9(0, 1000000000000);
	ASSERT_EQ(matrix9.getRows(), 0);
	ASSERT_EQ(matrix9.getColumns(), 1000000000000);
	
	ASSERT_NO_THROW(matrix::Matrix(-12, 6));
	matrix::Matrix matrix10(-12, 6);
	ASSERT_EQ(matrix10.getRows(), 0);
	ASSERT_EQ(matrix10.getColumns(), 0);
	
	ASSERT_NO_THROW(matrix::Matrix(9, -1223));
	matrix::Matrix matrix11(9, -1223);
	ASSERT_EQ(matrix11.getRows(), 0);
	ASSERT_EQ(matrix11.getColumns(), 0);
	
	ASSERT_NO_THROW(matrix::Matrix(-23423, -17890));
	matrix::Matrix matrix12(-23423, -17890);
...
TEST_F(TestMatrix, test_getRows_getColumns) {
	...
	matrix::Matrix matrix5(14, 18);
	ASSERT_EQ(matrix5.getRows(), 14);
	ASSERT_EQ(matrix5.getColumns(), 18);
	
	matrix::Matrix matrix6(10000, 100000);
	ASSERT_EQ(matrix6.getRows(), 10000);
	ASSERT_EQ(matrix6.getColumns(), 100000);
}
